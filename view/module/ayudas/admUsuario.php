...
<body class ="ContHelp">
    <header>
        <center><h1>USO DEL MODULO ADM DE USUARIO</h1></center>
    </header>
    <section>
        ...
        <center>
            <img src="http://localhost/INV_PRIV_1.0/view/img/reg_usuario.jpg" width="700px" height="500px" />
        </center>
        <p>
        <br><ul><h2>Interfaz Registar Módulo Usuario: </h2></ul><br>
        ...
        <center>
            <img src="http://localhost/INV_PRIV_1.0/view/img/eliminar_usuario.jpg" width="700px" height="500px" />
        </center>
        <p>
        <br><ul><h2>Interfaz Eliminar Módulo Usuario: </h2></ul><br>
        ...
        <center>
            <img src="http://localhost/INV_PRIV_1.0/view/img/editar_usuario.jpg" width="700px" height="500px" />
        </center>
        <p>
        <br><ul><h2>Interfaz Editar Módulo Usuario: </h2></ul><br>
        <h3><ul><ul><li>Primer paso, seleccionar usuario.</li></ul></ul></h3>
