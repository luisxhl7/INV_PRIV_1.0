...
<body class ="ContHelp">
    ...
    <section>
        ...
        <center>
            <img src="http://localhost/INV_PRIV_1.0/view/img/movimiento.jpg" width="700px" height="500px" />
        </center>
        <p>
        <br><ul><h2>Interfaz Módulo Movimientos: </h2></ul><br>
        ...
        <center>
            <img src="http://localhost/INV_PRIV_1.0/view/img/validar_movimiento.jpg" width="700px" height="500px" />
        </center>
        <p>
        <br><ul><h2>Interfaz Validar Módulo Movimientos: </h2></ul><br>
